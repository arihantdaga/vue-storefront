<template>
  <footer :class="{ 'brdr-top-1 brdr-cl-secondary': isCheckoutPage }">
    ...
    <div
      class="footer-links flex pt30 pb60 px40 bg-cl-white-smoke"
      v-if="!isCheckoutPage"
    >
      <div class="container">
        <div class="row m0 center-xs between-md">
          ...
          >
            <div class="start-md">
              ...
              <div class="mt15">
                <router-link class="cl-accent" :to="localizedRoute('/my-account')" exact>
                  {{ $t('My account') }}
                </router-link>
              </div>
              <div class="mt15">
                <router-link class="cl-accent" :to="localizedRoute('/delivery')" exact>
                  {{ $t('Delivery') }}
                </router-link>
              </div>
              <div class="mt15">
                <router-link class="cl-accent" :to="localizedRoute('/returns')" exact>
                  {{ $t('Return policy') }}
                </router-link>
              </div>
            </div>
            <div class="start-md">
              ...
              <div class="mt15">
                <router-link class="cl-accent" :to="localizedRoute('/customer-service')" exact>
                  {{ $t('Customer service') }}
                </router-link>
              </div>
              <div class="mt15">
                <router-link class="cl-accent" :to="localizedRoute('/size-guide')" exact>
                  {{ $t('Size guide') }}
                </router-link>
              </div>
              <div class="mt15">
                <router-link class="cl-accent" :to="localizedRoute('/contact')" exact>
                  {{ $t('Contact us') }}
                </router-link>
              </div>
            </div>
            <div class="start-md">
              ...
              <div class="mt15">
                <router-link class="cl-accent" :to="localizedRoute('/i/about-us')" exact>
                  {{ $t('About us ') }}
                </router-link>
              </div>
              <div class="mt15">
                <router-link class="cl-accent" :to="localizedRoute('/i/customer-service')" exact>
                  {{ $t('Customer service ') }}
                </router-link>
              </div>
              <div class="mt15">
                <router-link class="cl-accent" :to="localizedRoute('/store-locator')" exact>
                  {{ $t('Store locator') }}
                </router-link>
              </div>
            </div>
          ...
          <div class="row social mt30">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" class="facebook icon" width="40" height="40" viewBox="0 0 40 40" fill="#363b6e">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" class="instagram icon" width="40" height="40" viewBox="0 0 40 40" fill="#363b6e">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" class="pinterest icon" width="40" height="40" viewBox="0 0 40 40" fill="#363b6e">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" class="youtube icon" width="40" height="40" viewBox="0 0 40 40" fill="#363b6e">
