<template>
  <div class="sidebar-menu fixed mw-100 bg-cl-white-smoke">
    <div class="row brdr-bottom-1 brdr-cl-bg-white-smoke">
      <div
        v-if="submenu.depth"
    ...
    <div class="sidebar-menu__container row">
      <div class="col-xs-12 h4 serif">
        <ul class="p0 m0 relative sidebar-menu__list" :style="mainListStyles">
          <li
            @click="closeMenu"
            class="brdr-bottom-1 brdr-cl-bg-white-smoke bg-cl-primary"
          >
            <router-link
          ...
          <li
            class="brdr-bottom-1 brdr-cl-bg-white-smoke bg-cl-primary flex"
            :key="category.slug"
            @click="closeMenu"
          ...
          <li
            @click="login"
            class="brdr-bottom-1 brdr-cl-secondary bg-cl-white-smoke flex"
          >
            <sub-btn
              v-if="currentUser"
              :name="$t('My account')"
...
$bg-white-smoke: color(white-smoke);
...
.sidebar-menu {
  ...
  li {
    ...
    &.bg-cl-primary {
      &:hover,
      &:focus {
        background-color: $bg-white-smoke;
      }
    }
    a {
